...
public class HopDongView extends JFrame implements ActionListener {
	...
	private DsSinhVien danhsachSinhVien;
	...
	public HopDongView() {
		...
		JButton jButton_ChonTTSV = new JButton("Chọn TTSV");
...
//				long SDT = Long.valueOf(jtf_Sdt.getText());
				...
				SinhVien sv = new SinhVien(masv, tenSinhVien, GioiTinh, ngaysinh, QueQuan, NoiO, CCCD, SDT, MaNhanVien,
						Maphong);
